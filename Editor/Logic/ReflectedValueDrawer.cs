...
namespace ToolkitEditor
{
	...
	public class ReflectedValueDrawer<T> : PropertyDrawer
	{
		#region Methods
		...
		public override void OnGUI(Rect position, SerializedProperty property, GUIContent label)
		{
			...
			switch ((ReflectedValue<T>.ValueType)typeProperty.intValue)
			{
				case ReflectedValue<T>.ValueType.Value:
					EditorGUIRectLayout.PropertyField(ref position, valueProperty);
					break;

				case ReflectedValue<T>.ValueType.Member:
